...
# Added for CEUS
class Configuration_swin_multi():
    def parse(self, unknown_arg_ok=False):
        parser = ArgumentParser()
        ...
        # Data parameters
        parser.add_argument('--ceus_root', help='CEUS data root', default='data')
        parser.add_argument('--static_root', help='Static training data root', default='../static')
        parser.add_argument('--bl_root', help='Blender training data root', default='../BL30K')
        parser.add_argument('--yv_root', help='YouTubeVOS data root', default='../YouTube')
        parser.add_argument('--davis_root', help='DAVIS data root', default='../DAVIS')
        ...
        parser.add_argument('--stages', help='Training stage (0-static images, 1-Blender dataset, 2-DAVIS+YouTubeVOS, 4-CEUS)', default='4')
        ...
        # Stage 4, CEUS
        parser.add_argument('--s4_batch_size', default=4, type=int)
        parser.add_argument('--s4_iterations', default=60000, type=int)
        # fine-tune means fewer augmentations to train the sensory memory
        parser.add_argument('--s4_finetune', default=10000, type=int)
        parser.add_argument('--s4_steps', nargs="*", default=[5000, 20000], type=int)
        ...
        parser.add_argument('--s4_end_warm', default=40000, type=int)
        ...
        # Logging information
        parser.add_argument('--log_text_interval', default=1000, type=int)
        parser.add_argument('--log_image_interval', default=1000, type=int)
        parser.add_argument('--save_network_interval', default=20000, type=int)
        parser.add_argument('--save_checkpoint_interval', default=20000, type=int)
        parser.add_argument('--exp_id', help='Experiment UNIQUE id, use NULL to disable logging to tensorboard', default='NULL')
        parser.add_argument('--debug', help='Debug mode which logs information more often', action='store_true')
